...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-05-2024 a las 01:12:50
...
INSERT INTO `citas` (`id`, `pacientes_id`, `fecha`, `hora`, `estatus`, `tratamiento`) VALUES
(1, 1, '2024-05-21', '14:09:28', 'pendiente', 'comer');
...
CREATE TABLE `horarios` (
  `id` int(11) NOT NULL,
  `pacientes_id` int(11) DEFAULT NULL,
  `dia_semana` enum('domingo','lunes','martes','miércoles','jueves','viernes','sábado') DEFAULT NULL,
...
INSERT INTO `tipos_consulta` (`id`, `nombre`, `duracion`) VALUES
(1, 'Limpieza Dental', 30),
(2, 'Consulta General', 45),
(3, 'Extracción de Muela', 60),
(4, 'Ortodoncia', 90),
(5, 'Endodoncia', 120);
...
(5, 'alberto', 'es_un_muñeco', 'de_cartoncito@gmail.com', '12345678'),
...
--
ALTER TABLE `citas`
  ADD CONSTRAINT `citas_ibfk_1` FOREIGN KEY (`pacientes_id`) REFERENCES `pacientes` (`id`);

--
-- Filtros para la tabla `horarios`
--
ALTER TABLE `horarios`
  ADD CONSTRAINT `horarios_ibfk_1` FOREIGN KEY (`pacientes_id`) REFERENCES `pacientes` (`id`);
COMMIT;
