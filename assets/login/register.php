                    ...
                    <div class="card-body">
                        ...
                        <form action="#">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control text-white" id="nombre" placeholder="Ingrese su nombre">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control text-white" id="user" placeholder="Ingrese su usuario">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <input type="email" class="form-control text-white" id="correo" placeholder="Ingrese su correo">
                                </div>
                            </div>
                            
                            <div class="form-group row">
                                <label for="password" class="col-sm-12 col-form-label text-white">Contraseña:</label>
                                <div class="col-sm-10">
