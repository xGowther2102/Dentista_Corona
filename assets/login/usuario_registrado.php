            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 style="margin-bottom: 0;"> USUARIO REGISTRADO </h3> <!-- Added margin to h3 -->
                    </div>
                    <div class="card-body">
                        <br>
                        <div class="img-container">
                        ...
                        <form action="#">
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    <p class="destacado">
                                    "El usuario se ha creado correctamente. REDIRIGIENDO a la página de inicio de sesión o simplemente PULSA el botón de abajo para volver."
                                    </p>
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="row">
                                <br>
                                <div class="col-sm-12">
                                    <a href="../../iniciar_sesion.php" class="btn btn-secondary">Regresar al inico</a>
                                </div>
                            </div>
                        </form>
                        <br>
